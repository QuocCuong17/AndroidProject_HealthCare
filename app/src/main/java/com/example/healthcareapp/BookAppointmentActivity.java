...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed2.setText(address);
        ed3.setText(contact);
        ed4.setText("Chi phí tư vấn: " + fees);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(db.checkAppointMentExists(username,title+" => "+fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    Toast.makeText(BookAppointmentActivity.this, "Lịch hẹn đã được đặt trước", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    Toast.makeText(BookAppointmentActivity.this, "Đặt lịch hẹn thành công!!!", Toast.LENGTH_SHORT).show();
